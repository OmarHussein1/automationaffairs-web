...
function LanguageWrapper({
  ...
  return <Layout fullpage={fullpage}>{children}</Layout>;
}
      ...
      <Router>
        <Routes>
          ...
          <Route
            path="/de"
            element={
              <LanguageWrapper lang="de" fullpage>
                <Home />
              </LanguageWrapper>
            }
          />
          ...
          <Route
            path="/de/about"
            element={<Navigate to="/de/uber-uns" replace />}
          />
          <Route
            path="/de/contact"
            element={<Navigate to="/de/kontakt" replace />}
          />
          <Route
            path="/de/privacy"
